...
from antenna_parameters import five_patch_antenna, AntennaParameters
    ...
    for epoch in range(epochs):
        ...
        for x, v, p, w in train_data_loader:
            ...
            if classify:
                ...
                val = torch.tensor(five_patch_antenna.calculate_score(pred.detach().numpy()))
...
if __name__ == "__main__":
    ...
    antenna_parameters = five_patch_antenna
